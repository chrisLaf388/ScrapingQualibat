...
#Click plombier
choixChauff = driver.find_element_by_xpath('//*[@id="lim-back-research"]/div[2]/div/div[1]/form/div[2]/div[2]/div[19]/div[2]/div[1]')
choixChauff.click()
choixPlomb = driver.find_element_by_xpath('//*[@id="lim-back-research"]/div[2]/div/div[1]/form/div[2]/div[2]/div[19]/div[3]/div[1]')
choixPlomb.click()

# Localisation liste déroulante
departement = Select(driver.find_element_by_id("depblock"))
departement.select_by_value('38')
